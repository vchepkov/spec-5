...
%changelog
* Wed Jun 01 2011 Vadym Chepkov <vchepkov@gmail.com> - 1.6.17-1.vvc
- update to 1.6.17

* Fri Mar 04 2011 Vadym Chepkov <vvc@chepkov.com> - 1.6.16-2.vvc
- rebuild

* Thu Mar 03 2011 Vadym Chepkov <vvc@chepkov.com> - 1.6.16-1.vvc
- update to 1.6.16

* Wed Nov 24 2010 Vadym Chepkov <vvc@chepkov.com> - 1.6.15-1.vvc
- update to 1.6.15

* Fri Oct 01 2010 Vadym Chepkov <vvc@chepkov.com> - 1.6.13-1.vvc
- update to 1.6.13

* Mon Jun 21 2010 Vadym Chepkov <vvc@chepkov.com> - 1.6.12-1.vvc
- update to 1.6.12

* Fri Apr 16 2010 Vadym Chepkov <vvc@chepkov.com> - 1.6.11-0.vvc
- update to 1.6.11

* Sat Feb 13 2010 Joe Orton <jorton@redhat.com> - 1.6.9-1
- update to 1.6.9
